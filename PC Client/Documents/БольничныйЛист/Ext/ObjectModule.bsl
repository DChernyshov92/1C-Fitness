...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
    ...
    ДвижениеХозрасчётный.Сумма = Выборка.Сумма;        
    ДвижениеХозрасчётный.Содержание = "Отражено начисление по больничному листу";
    БухгалтерскийУчёт.ЗаполнитьСубконтоПоСчету(ДвижениеХозрасчётный.СчетДт, 
                    ДвижениеХозрасчётный.СубконтоДт, Выборка.СтатьяЗатрат);
    БухгалтерскийУчёт.ЗаполнитьСубконтоПоСчету(ДвижениеХозрасчётный.СчетКт, 
                        ДвижениеХозрасчётный.СубконтоКт, Выборка.Сотрудник);
КонецПроцедуры
